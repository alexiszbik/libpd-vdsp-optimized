...
t_int *scalarminus_perform(t_int *w)
{
    ...
    t_sample *out = (t_sample *)(w[3]);
    int n = (int)(w[4]);
    t_float minusf = f*-1.f;
    vDSP_vsadd(in, 1,&minusf , out, 1, n);
    return (w+5);
}
...
t_int *scalarminus_perf8(t_int *w)
{
    ...
    t_sample *out = (t_sample *)(w[3]);
    int n = (int)(w[4]);
    t_float minusg = g*-1.f;
    vDSP_vsadd(in, 1,&minusg , out, 1, n);
    return (w+5);
}
